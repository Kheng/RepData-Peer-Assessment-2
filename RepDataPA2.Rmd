...
```{r}
setwd("/Users/Kheng/Documents/Data Sceince/Reproducible Research/Peer Assessment 2")
```

3. Previewing characteristics and summary of the data.
```{r}
if (!"stormData" %in% ls()) {
    stormData <- read.csv("/Users/Kheng/Documents/Data Sceince/Reproducible Research/Peer Assessment 2/stormData.csv", sep = ",")
}
dim(stormData)
head(stormData, n = 2)
```
